        ...
        <div class="plu-navbar-inner">
            <div class="container">
                ...
                <#--  <button id="plu-btn-navbar" type="button" class="btn-navbar" data-toggle="collapse" data-target="#plu-nav-collapse">
                    <svg class="lexicon-icon lexicon-icon-align-justify" role="presentation"><use xlink:href="/images/icons/icons.svg#align-justify"></use></svg>
                </button>  -->

                <!-- Main navigation -->
                <div id="plu-nav-collapse" class="navbar-collapse collapse pull-right show" aria-expanded="true">
